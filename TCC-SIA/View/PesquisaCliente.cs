...
namespace TCC_SIA.View
{
    public partial class PesquisaCliente : Form
    {
        ...
        private void atualiza_Cliente(object sender, LinkLabelLinkClickedEventArgs e)
        {
            if (dataGridViewPesquisar.SelectedRows.Count > 0)
            {
                ...
                if (res == DialogResult.OK)
                {
                    ...
                    maskedTextBoxEmail.Text = dataGridViewPesquisar.CurrentRow.Cells[3].Value.ToString();
                    dateTimePickerNasc.Value = Convert.ToDateTime(dataGridViewPesquisar.CurrentRow.Cells[4].Value.ToString());
                    comboBoxSexo.SelectedIndex = comboBoxSexo.FindString(dataGridViewPesquisar.CurrentRow.Cells[5].Value.ToString());
                    maskedTextBoxTelefone.Text = dataGridViewPesquisar.CurrentRow.Cells[6].Value.ToString();
                    maskedTextBoxNumero.Text = dataGridViewPesquisar.CurrentRow.Cells[7].Value.ToString();
                    textBoxRua.Text = dataGridViewPesquisar.CurrentRow.Cells[8].Value.ToString();
                    textBoxCidade.Text = dataGridViewPesquisar.CurrentRow.Cells[9].Value.ToString();
                    maskedTextBoxCep.Text = dataGridViewPesquisar.CurrentRow.Cells[10].Value.ToString();
                    textBoxBairro.Text = dataGridViewPesquisar.CurrentRow.Cells[11].Value.ToString();
                    comboBoxEstado.SelectedIndex = comboBoxEstado.FindStringExact(dataGridViewPesquisar.CurrentRow.Cells[12].Value.ToString());
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            mCliente.setIdCliente(Convert.ToInt32(maskedTextBoxID.Text));
